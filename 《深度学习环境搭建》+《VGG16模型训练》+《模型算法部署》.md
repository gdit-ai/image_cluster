...
打开终端输入：`lsmod | grep nouveau`![](https://img-blog.csdnimg.cn/20191218114819650.jpg)
如果没有任何显示，则表示禁用正常
...
查看显卡信息：          `nvidia-smi`
![](https://img-blog.csdnimg.cn/2019121821242521.jpg)
...
安装过程中的选项
![](https://img-blog.csdnimg.cn/20191218212924953.png)
2. 测试CUDA
...
3. 出现如下信息，则安装成功
![](https://img-blog.csdnimg.cn/20191218213416178.png)
4. 安装完成后，设置环境变量      
...
![](https://img-blog.csdnimg.cn/20191218213657735.png)
...
爬取一个类示例：
![](https://img-blog.csdnimg.cn/20191218140829865.png)
...
将所有图片读取示例：
![](https://img-blog.csdnimg.cn/20191218140913593.png)
**出现下方错误证明是爬取的图片无法读入，找到相对应的图片删除就好。**
![](https://img-blog.csdnimg.cn/20191218140930666.png)
### 数据增强
...
```
![输出文件夹对应标签](https://img-blog.csdnimg.cn/20191218141115236.png)
...
![](https://img-blog.csdnimg.cn/20191218141225174.png)
![](https://img-blog.csdnimg.cn/20191218141317247.png)
### 训练准确率折线图绘制
...
![](https://img-blog.csdnimg.cn/20191218141344124.png)
![](https://img-blog.csdnimg.cn/20191218141356764.png)
## 三、模型预测的页面可视化
### 项目结构
![](https://img-blog.csdnimg.cn/20191218145155405.png)
...
![](https://img-blog.csdnimg.cn/20191218150359742.png)
...
![](https://img-blog.csdnimg.cn/20191218201701550.png)
>补充：若项目运行出现这种报错，是因为路径的问题所导致，建议使用Ubuntu系统运行flask程序，或者将用到的路径全部更换为绝对路径
### 运行程序
打开终端输入`python app.py`
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191219230603679.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQzODQzNTUw,size_16,color_FFFFFF,t_70)
此时服务器即为启动状态，打开浏览器，通过127.0.0.1:5000或者ip:5000的方式访问网页，上传图像，进行识别并在前端进行展示
![在这里插入图片描述](https://img-blog.csdnimg.cn/20191219230919650.png)
